<?php
    $sections = [
        ...
        $secondSection = ["title"=> "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
        "paragraphs" => [
            ...
            "<a href='https://safety.google/' target='_blank'>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.",
            
            ]
        ],
        $thirdSection = ["title"=> "Perché il mio account è associato a un paese?",
        "paragraphs" => [
...
<body>
    <header>
        <div id="top-header" class="d-flex justify-content-between">
            ...
            <div id="user-login" class="d-flex align-items-center">
